...
#include "SDI12SensorsR.h"


// The constructor - need the number of measurements the sensor will return, SDI-12 address, the power pin, and the data pin
SDI12SensorsR::SDI12SensorsR(char SDI12address, int8_t powerPin, int8_t dataPin, uint8_t measurementsToAverage,
...
SDI12SensorsR::SDI12SensorsR(int SDI12address, int8_t powerPin, int8_t dataPin, uint8_t measurementsToAverage,
                           const char *sensorName, const uint8_t numReturnedVars,
                           uint32_t warmUpTime_ms, uint32_t stabilizationTime_ms, uint32_t measurementTime_ms)
    : Sensor(sensorName, numReturnedVars,
             warmUpTime_ms, stabilizationTime_ms, measurementTime_ms,
...
// Destructor
SDI12SensorsR::~SDI12SensorsR(){}


bool SDI12SensorsR::setup(void)
{
...
bool SDI12SensorsR::requestSensorAcknowledgement(void)
{
    // Empty the buffer
    _SDI12Internal.clearBuffer();
...
bool SDI12SensorsR::getSensorInfo(void)
{
...
// The sensor vendor
String SDI12SensorsR::getSensorVendor(void)
{return _sensorVendor;}

// The sensor model
String SDI12SensorsR::getSensorModel(void)
{return _sensorModel;}

// The sensor version
String SDI12SensorsR::getSensorVersion(void)
{return _sensorVersion;}

// The sensor serial number
String SDI12SensorsR::getSensorSerialNumber(void)
{return _sensorSerialNumber;}


// The sensor installation location on the Mayfly
String SDI12SensorsR::getSensorLocation(void)
{
...
bool SDI12SensorsR::startSingleMeasurement(void)
{
...
bool SDI12SensorsR::addSingleMeasurementResult(void)
{
    bool success = false;
