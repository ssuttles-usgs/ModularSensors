...
#define MS_DEBUGGING_STD "SDI12SensorsR"
#endif
...
class SDI12SensorsR : public Sensor
{
public:

    SDI12SensorsR(char SDI12address, int8_t powerPin, int8_t dataPin, uint8_t measurementsToAverage = 1,
    ...
    SDI12SensorsR(char *SDI12address, int8_t powerPin, int8_t dataPin, uint8_t measurementsToAverage = 1,
                 const char *sensorName = "SDI12-Sensor", const uint8_t numReturnedVars = 1,
                 uint32_t warmUpTime_ms = 0, uint32_t stabilizationTime_ms = 0, uint32_t measurementTime_ms = 0);
    SDI12SensorsR(int SDI12address, int8_t powerPin, int8_t dataPin, uint8_t measurementsToAverage = 1,
                 const char *sensorName = "SDI12-Sensor", const uint8_t numReturnedVars = 1,
                 uint32_t warmUpTime_ms = 0, uint32_t stabilizationTime_ms = 0, uint32_t measurementTime_ms = 0);
    virtual ~SDI12SensorsR();
